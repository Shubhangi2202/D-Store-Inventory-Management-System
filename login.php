						...
						<div class="card">
							...
							<div class="card-body">
								<div style="text-align: center;">
									<span><img class=" logo" src="projectlogo.png" alt="" width="40%" height="40%"></span>
								</div>
								<form action="">
									...
									<div class="form-group">
										<label for="instituteid">Enter Institute ID image<span class="requiredIcon">*</span></label>
										<input class="form-control" placeholder="instituteid" type="file" name="image" accept="image/*" required>
										<small id="e_error" class="form-text text-muted">Upload you Institution Id Card image</small>
									</div>
									<div>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="">
							...
							<div class="form-group"><label for="loginUsername">Username</label><input type="text" class="form-control" id="loginUsername" name="loginUsername"></div>
