										...
										<form>
											<div class="form-row">
												...
												<div class="form-group col-md-3">
													...
													<input class="form-control invTooltip" type="number" readonly id="itemDetailsProductID" name="itemDetailsProductID" title="This will be auto-generated when you add a new item. But incase of updating existing items you need to enter the id after searching for the product.">
												</div>
												<div class="form-group col-md-3">
												...
												<div class="form-group col-md-2">
													<label for="itemDetailsStatus">Acquire/Discard Mode<span class="requiredIcon">*</span></label>
											...
											<div class="form-row">
												...
												<div class="form-group col-md-2">
													...
													<input type="number" class="form-control" id="itemDetailsQuantity" name="itemDetailsQuantity" value="0">
												</div>
												<div class="form-group col-md-3">
								...
								<form>
									<div class="form-row">
										...
										<div class="form-group col-md-3">
											...
											<input type="text" class="form-control invTooltip" id="vendorDetailsVendorID" name="vendorDetailsVendorID" title="This will be auto-generated when you add a new vendor. But incase of updating any existing details you need to enter valid Vendor ID." autocomplete="off">
							...
							<div class="card-body">
								...
								<div class="tab-content">
									<div id="itemReportsTab" class="container-fluid tab-pane active">
										<br>
										<p>Use the grid below to get reports for items report</p>
